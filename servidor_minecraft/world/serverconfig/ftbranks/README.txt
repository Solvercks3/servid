...
Last README file update: Mon Jan 27 17:20:16 UTC 2025
...
command.pvpFlag.off
command.pvpFlag.on
command.pvpFlag.status
command.pvpZone
command.pvpZone.add
command.pvpZone.add.name
command.pvpZone.add.name.x1
command.pvpZone.add.name.x1.z1
command.pvpZone.add.name.x1.z1.x2
command.pvpZone.add.name.x1.z1.x2.z2
command.pvpZone.add.name.x1.z1.x2.z2.buffer
command.pvpZone.list
command.pvpZone.remove
command.pvpZone.remove.name
command.random
